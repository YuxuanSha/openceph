...
export function appendToSection(content, sectionName, newEntry) {
...
export function generateMemoryId(date, existingContent) {
...
export function findMemoryById(content, memoryId) {
...
export function replaceMemoryById(content, memoryId, newText) {
...
export function deleteMemoryById(content, memoryId) {
    const found = findMemoryById(content, memoryId);
    if (!found)
        return content;
    const lines = content.split("\n");
...
export function normalizeMemoryId(memoryId) {
