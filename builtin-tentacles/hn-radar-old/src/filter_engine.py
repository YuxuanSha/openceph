...
def _resolve_llm_config() -> tuple[str | None, str | None, str]:
    ...
    api_key = os.environ.get("OPENCEPH_LLM_API_KEY") or os.environ.get("OPENROUTER_API_KEY")
    base_url = os.environ.get("OPENCEPH_LLM_BASE_URL") or os.environ.get("OPENROUTER_BASE_URL") or "https://openrouter.ai/api/v1"
    model = os.environ.get("OPENCEPH_LLM_MODEL") or os.environ.get("OPENROUTER_MODEL") or "anthropic/claude-haiku-4-5"
